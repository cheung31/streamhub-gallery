define([
    ...
    CoverflowAnimator.prototype._transforms.contentBefore = { transforms: { scale: 0.6, rotateY: '75deg' } };
    CoverflowAnimator.prototype._transforms.contentAfter = { transforms: { scale: 0.6, rotateY: '-75deg' } };
